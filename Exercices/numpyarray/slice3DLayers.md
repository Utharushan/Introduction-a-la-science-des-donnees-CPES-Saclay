...
NROWS: CONST = RANDOM_INT(1, 6)
NCOLUMNS: CONST = RANDOM_INT(10,12)
NLAYERS: CONST = RANDOM_INT(4,8)
START: CONST = RANDOM_INT(1, NLAYERS-1)     # number of first selected layer
END: CONST = RANDOM_INT(START+2, NLAYERS+1) # number of last selected layer, excluded
```
...
Extraire de T le sous-tableau ne contenant que les START ièmes à END
ièmes couches (incluses).
