...
NROWS: CONST = RANDOM_INT(5, 8)
NCOLUMNS: CONST = RANDOM_INT(10,12)
START: CONST = RANDOM_INT(1, NROWS-1)     # number of first selected row
END: CONST = RANDOM_INT(START+2, NROWS+1) # number of last selected row, excluded
SIZE: CONST = END - START                 # number of selected rows
```
...
Extraire SIZE lignes du tableau T à partir de la START ème ligne.
